...
import { ArrowLeft, Plus, Trash2, User, Users, MapPin, Bus, CheckCircle, Calendar } from 'lucide-react';
...
export default function NonASNRegistrationPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white py-8 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <Link href="/mudikgratis" className="inline-flex items-center text-emerald-600 hover:text-emerald-800 mb-4">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Pendaftaran Non-ASN</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Data diri peserta utama (Honorer/Tenaga Kontrak)</CardDescription>
            </CardHeader>
          ...
          {/* Summary */}
          <Card className="bg-gradient-to-br from-emerald-50 to-blue-50 border-2">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
